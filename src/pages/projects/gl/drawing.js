    ...
    <div style={style_page_bg}>
      ...
      <div style={style_section}>
        ...
        <div style={{ ...style_cert_item, padding: isMobile ? '18px' : '28px', marginBottom: '16px' }}>
          ...
          <div style={{ fontSize: isMobile ? '13px' : '16px', color: colors.muted, lineHeight: '1.8' }}>My second WebGL project. A canvas where you can draw dots at random positions with random colors every frame. Also includes erasing and deleting dots. This helped me understand how to manipulate pixels directly in WebGL.</div>
        </div>
        <div style={{ ...style_cert_item, padding: isMobile ? '18px' : '28px', marginBottom: '16px' }}>
        ...
        <div style={{ ...style_cert_item, padding: isMobile ? '18px' : '28px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <div style={{ width: `${DEMO_WIDTH * scale}px`, height: `${DEMO_HEIGHT * scale}px`, overflow: 'hidden', borderRadius: '12px' }}>
              <iframe src={process.env.PUBLIC_URL + "/files/drawing.html"} title="Drawing Demo" scrolling="no"
