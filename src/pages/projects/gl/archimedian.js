    ...
    <div style={style_page_bg}>
      ...
      <div style={style_section}>
        ...
        <div style={{ ...style_cert_item, padding: isMobile ? '18px' : '28px', marginBottom: '16px' }}>
          ...
          <div style={{ fontSize: isMobile ? '13px' : '16px', color: colors.muted, lineHeight: '1.8' }}>Taught me the math behind generating an Archimedean spiral by stepping through angles and radii. I also attached rotating squares to each point of the spiral to visualize how the curve grows as it turns. Helped me get comfortable combining geometry, animation loops, and transformations. The spiral must be generated before the squares & refresh the browser to reset.</div>
        </div>
        <div style={{ ...style_cert_item, padding: isMobile ? '18px' : '28px', marginBottom: '16px' }}>
