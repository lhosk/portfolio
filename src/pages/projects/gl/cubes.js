  ...
  return (
    <div style={style_page_bg}>
      ...
      <div style={style_section}>
        <div style={style_section_title}>Indexing Moving Cubes</div>
        <div style={{ ...style_cert_item, padding: isMobile ? '18px' : '28px', marginBottom: '16px' }}>
          ...
          <div style={{ fontSize: isMobile ? '13px' : '16px', color: colors.muted, lineHeight: '1.8' }}> This program was a big step up! It shows transformations in 3D space and updating cubes using matrix operations for translation, rotation, and scaling. Each cube fires off in a different direction along the x, y, and z axes. This was the first time WebGL really clicked for me in terms of how 3D graphics pipelines actually work.</div>
        </div>
        <div style={{ ...style_cert_item, padding: isMobile ? '18px' : '28px', marginBottom: '16px' }}>
          ...
          <a href="https://github.com/lhosk/opengl-and-webgl/tree/main/exploding_cubes" target="_blank" rel="noreferrer" style={{ fontFamily: fonts.mono, fontSize: '13px', color: colors.accent, textDecoration: 'none' }}>View on GitHub ↗</a>
        </div>
        <div style={{ ...style_cert_item, padding: isMobile ? '18px' : '28px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <div style={{ width: `${DEMO_WIDTH * scale}px`, height: `${DEMO_HEIGHT * scale}px`, overflow: 'hidden', borderRadius: '12px' }}>
              <iframe src={process.env.PUBLIC_URL + "/files/cubes.html"} title="Cubes Demo" scrolling="no"
