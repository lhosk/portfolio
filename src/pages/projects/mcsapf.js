...
function McsApf() {
  const imgStyle = { width: '100%', maxWidth: '700px', maxHeight: '550px', objectFit: 'contain', display: 'block', margin: '0 auto', borderRadius: '12px' };
  return (
    <div style={style_page_bg}>
      ...
      <div style={style_section}>
        ...
        <div style={{ ...style_cert_item, padding: '28px', marginBottom: '16px' }}>
          ...
          <img src={mcsapfImage} alt="Atomic Packing Factor Setup" style={imgStyle} />
        </div>
